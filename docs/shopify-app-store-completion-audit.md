...
| Dashboard submission evidence template | `docs/shopify-dashboard-submission-evidence-template.md` defines the proof that must be pasted into EVNSolution/shopify-clever#6 and EVNSolution/clever-change-control#211 before closure. | Done |
