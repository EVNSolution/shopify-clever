...
test("Orders Add filter static labels and options have Korean dictionary coverage", () => {
  const expectedTranslations = {
    ...
    "orders.filters.serviceCategory.label": "배송 / 픽업",
    "orders.filters.serviceCategory.all": "전체",
    "orders.filters.serviceCategory.delivery": "배송",
    "orders.filters.serviceCategory.pickup": "픽업",
  ...
  const remainingStaticKeys = [
    ...
    "orders.filters.serviceCategory.aria",
