...
test("Orders inventory detail shows a printable product matrix without delta", () => {
  ...
  assert.match(inventoryDetailSource, /\.inventory-detail-orders-head \{ border-bottom: \$\{strongDividerStyle\} !important; font-size: 12px !important; font-weight: 750 !important; line-height: 16px !important; margin-bottom: 8mm !important/);
  ...
  assert.match(inventoryDetailSource, /\.inventory-detail-order-row \{ border-bottom: \$\{subtleDividerStyle\} !important; font-size: 12px !important; line-height: 17px !important; padding: 4mm 0 !important; \}/);
